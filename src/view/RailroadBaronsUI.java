...
/**
 * The main entry point for the Railroad Gameplay UI.
 */
public class RailroadBaronsUI extends Application
    ...
    private static final String TITLE =
            "Railroad Gameplay! A Totally Original Game.";
    ...
    /**
     * The primary {@link Stage} in which the Railroad Gameplay used interface
     * is updated.
     */
    private Stage primaryStage;

    /**
     * Creates the Railroad Gameplay UI.
     */
    public RailroadBaronsUI() {
        // this should be in a class...
        chooser = new FileChooser();
        chooser.getExtensionFilters().addAll(
            new ExtensionFilter("Railroad Gameplay Maps (*.rbmap)", "*.rbmap"),
    ...
    /**
     * Builds the {@linkplain MenuBar menu bar} used by the Railroad Gameplay
     * users to load and save maps.
     *
     * @return The Railroad Gameplay {@link MenuBar}.
     */
