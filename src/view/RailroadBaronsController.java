...
/**
 * The main controller in the Railroad Gameplay GUI. In the Railroad Gameplay
...
public class RailroadBaronsController implements RailroadMapObserver,
    ...
    /**
     * Creates a new controller for use by the Railroad Gameplay UI. The
     ...
     * which games of Railroad Gameplay are played. The following requirements
     * must be satisfied:
     * <ul>
     ...
     *     Railroad Gameplay {@link model model package}.</li>
     ...
     * {@linkplain RailroadBarons Railroad Gameplay} interface that will
     * henceforth be used play Railroad Gameplay. The following requirements
     * must be satisfied:
     * <ul>
     *     <li>The specified class name is fully qualified, i.e. contains the
     ...
     *     the Railroad Gameplay {@link model model package}.</li>
     *     <li>The specified class has a default or parameterless
     *     constructor.</li>
     *     <li>The class and its constructor must be accessible from outside
     *     of its package (i.e. public)</li>
     ...
     * the Railroad Gameplay UI to display information to the current
     * {@linkplain Player player}, and allow the player to start and end a
     * turn.
     *
     * @return The {@link PlayerControlPane} used by the Railroad Gameplay UI.
     */
     ...
     * Railroad Gameplay UI to display the map on which the current game is
     * being played.
     *
     * @return The {@link RailroadMapPane} that is used by the Railroad Gameplay
     * UI.
     */
     ...
     * refers and uses it to start a new game of Railroad Gameplay!
     *
     * @param path The path to the Railroad Gameplay map file that should be
    ...
    /**
     * Updates the Railroad Gameplay UI in response to a newly claimed
